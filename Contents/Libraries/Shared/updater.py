...
class Updater(object):
    def __init__(self, core, channel, repo='IIeTp'):
        ...
        self.stable_url = 'https://api.github.com/repos/%s/TheMovieDB.ID.bundle/releases/latest' % self._repo
        self.beta_url = 'https://api.github.com/repos/%s/TheMovieDB.ID.bundle/git/refs/heads/beta' % self._repo
